...
const RevenueChart = () => {
	...
	return (
		<motion.div
			className='bg-gray-800 bg-opacity-50 overflow-hidden backdrop-filter backdrop-blur-lg shadow-lg rounded-xl p-6 border border-gray-700 mb-8'
			initial={{ opacity: 0, y: 20 }}
			animate={{ opacity: 1, y: 0 }}
			transition={{ delay: 0.2 }}
		>
			<div className='flex justify-between items-left flex-col gap-4 sm:flex-row mb-6'>
